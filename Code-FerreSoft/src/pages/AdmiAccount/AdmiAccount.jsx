    ...
    return (
        <>
            <div className="container admicontainer mt-4">
                <p className="text-center fs-2 fw-bold">Cuenta - Administrador</p>
                <div className="row">
                        ...
                        <div className="card rounded-1 card1">
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <h5>
                                            <NavLink to='/prsn-admin-info' className="text-decoration-none card-title">Informacion Personal</NavLink>
                                        </h5>
                        ...
                        <div className="card rounded-1 card1">
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <h5>
                                            <NavLink to='/gestionar-empleado' className="text-decoration-none card-title">
                        ...
                        <div className="card rounded-1 card1">
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <h5 className="card-title"><NavLink to='/gestionar-factura' className="text-decoration-none card-title">Control de facturas</NavLink></h5>
                                        <p className="card-text">Edita las facturas segun los pedidos y visualiza las facturas creadas</p>
                                    </div>
                                </div>
                            </div>
                        </div>
